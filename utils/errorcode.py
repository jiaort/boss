...
class ERRORCODE(object):
    ...
    TIMES_NOT_ENOUGH = StatusCode(COMMON_BASE + 18, "The remaining not enough", "剩余次数不足")
    PROVIDER_PLATFORM_ERROR = StatusCode(COMMON_BASE + 19, "platform error.", "第三方平台错误")
    METHOD_NOT_ALLOWED = StatusCode(COMMON_BASE + 20, "method not allowed.", "请求方法错误")
    USER_REPEAT = StatusCode(COMMON_BASE + 21, "repeat applicant.", "重复申请职位")
